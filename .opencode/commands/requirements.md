---
description: Create detailed feature specifications with user stories, acceptance criteria, and edge cases. Use when starting a new feature or initializing a new project or when the user provides a feature idea or requirement.
---
...
Ask the user one question at a time, presenting clear single/multiple choice options where useful.
...
- Create a feature spec file using [features/template.md](features/template.md)
...
> Next step: Run `/technical-design PROJ-1` to design the technical approach."
...
Ask one question at a time, with clear single/multiple choice options where useful.
...
> "Feature spec is ready! Next step: Run `/technical-design PROJ-X` to design the technical approach."
...
## Important
- NEVER write code - that is for implementation skills
- NEVER create tech design - that is for the `/technical-design` skill
